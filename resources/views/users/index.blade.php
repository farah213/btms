...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{url('Frontend/aos.css')}}" rel="stylesheet">
  <link href="{{url('Frontend/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{url('Frontend/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{url('Frontend/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{url('Frontend/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{url('Frontend/swiper-bundle.min.css')}}" rel="stylesheet">
