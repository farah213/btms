...
@csrf
        ...
        <div class="row mt-4">
            ...
            <div class="col-sm-6"> <select class="browser-default custom-select mb-4" required id="select" name="time">
        ...
        <!--Fifth Row-->
        <div class="row">
            <div class="col-sm-4"> <select class="browser-default custom-select mb-4" reqyuired id="coach_type" name="coach_type">
