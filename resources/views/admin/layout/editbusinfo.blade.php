...
<form action="{{route('bus.update')}}" method="post">
  ...
  <div class="mb-3">
   ...
   <div class="mb-3">
    ...
    <input type="integer"  name="seat_availablity"value="{{$bus->seat_availablity}}" class="form-control"required >
  </div>
  <div class="mb-3">
    <label for="example" class="form-label">Seat-number</label>
    <input type="integer"  name="seat_number"value="{{$bus->seat_number}}" class="form-control"required >
  </div>
